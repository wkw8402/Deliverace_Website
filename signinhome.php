     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="signinhome.php"><image><img src="images/brand.png"/></image></a>
               </div>
               ...
               <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="home.php" class="#" ><button class = "section-btn">Sign Out</button></a></li>
                    </ul>
               </div>
                              ...
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
                                             ...
                                             <h1>Welcome back! We hope you enjoy our food once more again!</h1>
     ...
     <section id="testimonial" data-stellar-background-ratio="0.5">
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="team-thumb wow fadeInUp" data-wow-delay="0.2s">
                              <li><a href="ordertakeout.php" class="#" ><img src="images/takeout.jpg" class="img-responsive" alt=""></a></li>
                         </div>
                    </div>
                   ...
                   <div class="col-md-4 col-sm-4">
                         <div class="team-thumb wow fadeInUp" data-wow-delay="0.2s">
                              <li><a href="orderdelivery.php" class="#" ><img src="images/delivery.jpg" class="img-responsive" alt=""></a></li>
                         </div>
                    </div>
