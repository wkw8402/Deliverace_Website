...
<head>
	<meta charset="UTF-8">
	<title>Take Out Order Page</title>
	<link rel="stylesheet" href="css/interactive-style3.css">
...
<body>
    ...
    <div class="wrapper">
        ...
        if(isset($_POST['submit_btn']))
        {
            ...
            $query= "insert into takeoutordertable values('$vouchercode','$member','$email','$phone','$meal1','$meal2','$meal3', '$totalprice')";
                    $query_run = mysqli_query($con,$query);
                    echo '<script type="text/javascript"> alert("Your order has been taken successfully. Your order code is  [' . $vouchercode . ']. Please show this code to our employee when you pick up your food. Thank you so much for your purchase and hope to serve you again!")</script>';		
        }
    ?>
