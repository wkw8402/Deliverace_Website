    ...
    <div class="wrapper">
        ...
        if(isset($_POST['submit_btn']))
        {
            ...
            $query= "insert into deliveryordertable values('$vouchercode','$member','$email','$phone','$street','$apt','$meal1','$meal2','$meal3','$totalprice')";
					...
					echo '<script type="text/javascript"> alert("Your order has been taken successfully. Your order code is [' . $vouchercode . ']. Please show this code to our delivery man when you pick up your food. Thank you so much for your purchase and hope to serve you again!")</script>';	
        }
    ?>
